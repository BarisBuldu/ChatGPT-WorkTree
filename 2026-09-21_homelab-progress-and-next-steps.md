...
- [ ] **Phase 7 güvenlik blocker'ı:** Public context redaction şu an çalışıyor görünse de sızmış Sonoff/eWeLink credential rotate edilir, aktif Home Assistant config `secrets.yaml`/eşdeğer secret reference'a taşınır ve public/backup/history kopyalarında plaintext kalmadığı değer ifşa edilmeden doğrulanır. Sanitizer tek başına containment'tır, remediation değildir.

**Sonraki sıra:** Önce credential containment/rotation ve Agy commit/push/remote kanıtı; sonra P7-01 için DNS mimarisi kullanıcı kararı ve Deco değişikliği; P7-03 gerçek kritik servis restore; P7-02/P7-04 eksik etki/failure kanıtları; en son P7-05 toplu gate. Phase 7 kapandıktan sonra Phase 8 manga storage önkoşulu ve gerçek Suwayomi+Komga/okuma/offline/restore; ardından önceki fazlardan açık güvenlik/ürün kapıları ve Phase 9 Tdarr/Frigate/Immich, commit performansı, en son AI kota sayfası ve master final kabul. Manga path'i `/mnt/downloads` yalnız adaydır; mount/UID/quota/backup canlı doğrulanır.
