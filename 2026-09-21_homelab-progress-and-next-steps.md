...
- [ ] **Phase 7 credential containment:** Kullanıcı 2026-09-22'de Sonoff/eWeLink şifresini değiştirmemeyi ve kimsenin görmediğini varsayarak yalnız dış sızıntıyı engellemeyi açıkça seçti. Rotation zorunlu gate değildir; kabul edilen risk olarak kaydedilir. Aynı mevcut değer aktif Home Assistant config'te `secrets.yaml`/eşdeğer secret reference'a taşınır; public context/export yolları redacted kalır ve hiçbir public endpoint'in plaintext döndürmediği değer ifşa edilmeden doğrulanır. Private backup içeriği izinsiz silinmez/değiştirilmez; doğrudan public servis edilmesi engellenir.
